...
class AbstractForm(models.Model):
    ...
    intro = models.TextField(_("Intro"), blank=True, help_text="Form Introduction")
    button_text = models.CharField(_("Button text"), max_length=50,
        default=_("Submit"), help_text="This is the submit button which will be displayed")
    response = models.TextField(_("Response"), blank=True, default="Form submission success!", help_text="This is the response after the form has been submitted")
